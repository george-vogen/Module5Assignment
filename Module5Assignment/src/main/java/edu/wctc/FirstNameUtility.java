...
public class FirstNameUtility {
    ...
    public FirstNameUtility() {
        ...
        // Example values (your assignment file likely contains the full dataset)
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        if (firstNameCodeMap.containsKey(firstName)) {
            firstCode = firstNameCodeMap.get(firstName);
        } else {
            String firstInitial = firstName.substring(0,1);
            firstCode = firstInitialCodeMap.getOrDefault(firstInitial,0);
        }
        ...
        if (middleInitial != null && !middleInitial.isBlank()) {
            ...
            middleCode = middleInitialCodeMap.getOrDefault(middleInitial,0);
        }

        return firstCode + middleCode;
    }
}
